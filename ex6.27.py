...
# random match-mismatch values
dict = {'Match': 1, 'Mismatch': -1, 'Gap': -2}
...
def fill_score_matrix():
    ...
    # fill rest of the table and save hor-ver-diag values for the traceback
    for i in range(len(seq2)):
        for j in range(len(seq1)):
            ...
            if seq2[i] == seq1[j]:
                ...
                diagonal_score = score_matrix[i][j] + dict['Mismatch']
